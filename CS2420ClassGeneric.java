...
/**
 * This Java class represents an ordered collection of University of Utah students enrolled in CS 2420.
 * @param <Type> students with generic contact information
 * 
...
public class CS2420ClassGeneric<Type> {
	...
	public double computeClassAverage() {
	    ...
	    for (CS2420StudentGeneric<Type> student : studentList) {
	        double score = student.computeFinalScore();
	        if (score > 0) {  
	            total += score;
	            count++;
	        }
	 ...
	 * Compares by their scores then uNID if their scores are the same.
	 *  uNIDs are guaranteed to be unique. This will sort in descending order.
	 */
